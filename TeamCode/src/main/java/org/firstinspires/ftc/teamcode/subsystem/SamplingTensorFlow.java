    ...
    public String getPosition() {
        ...
        for (Recognition recognition : updatedRecognitions) {
            ...
            if (
                  ...
                  height > 50 && height < 160 && width > 50 && width < 160 &&
                  //Check if the ratio is "square" enough to be a detection
                  (
                  (ratio < 1.4 && ratio > 0.65 && recognition.getLabel() == LABEL_SILVER_MINERAL) ||
                  (ratio < 1.4 && ratio > 0.8 && recognition.getLabel() == LABEL_GOLD_MINERAL)
                  )
